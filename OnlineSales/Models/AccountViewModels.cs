...
namespace OnlineSales.Models
{
    ...
    //{
    //    [Required]
    //    [StringLength( 17 , ErrorMessage = "The {0} must be at least {2} characters long.", MinimumLength = 16)]
    //    [Display(Name = "Card Number")]
    //    public long Number { get; set; }

    //    [Required]
    //    [StringLength( 9 , ErrorMessage = "The {0} must be at least {2} characters long., the format is MM/DD/YYYY", MinimumLength = 8)]
